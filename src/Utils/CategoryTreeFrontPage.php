...
class CategoryTreeFrontPage extends CategoryTreeAbstract
{
    ...
    {
        $this->slugger = new AppExtensionRuntime; // Twig extension to slugify url's for categories
        ...
        $categories_array = $this->buildTree($parentData['id']); // build array for generating nested html list
