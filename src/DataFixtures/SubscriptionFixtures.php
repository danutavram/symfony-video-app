...
class SubscriptionFixtures extends Fixture
{
    ...
    {
        return [
            [1, Subscription::getPlanDataNameByIndex(2), (new DateTime())
            ->modify('+100 year'), 'paid', false],
            [3, Subscription::getPlanDataNameByIndex(0), (new DateTime())
            ->modify('+1 month'), 'paid', true],
            [4, Subscription::getPlanDataNameByIndex(1), (new DateTime())
            ->modify('+1 minute'), 'paid', false]
